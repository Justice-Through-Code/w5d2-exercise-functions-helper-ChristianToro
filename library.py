...
# The structure of data in books_with_details is a list of dictionaries, each dictionary for each book. There are key value pairs for each book.
...
def search_by_author(author: str):
    ...
    for book in books_with_details:
        if book.get('author') == author:
            authors_list.append(book.get('title'))
    return authors_list
